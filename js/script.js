$(document).ready(function() {
  ...
  "quoteAuthor": "Leonardo da Vinci"
     ...
     "quoteAuthor": "Bart?omiej Tuchowski"
     }];
    ...
    //Calling fadeInQuote function when site refreshes.
    fadeInQuote();
     
    //Getting new Quote
    $(".new-quote").on("click", function () {
      $("body").fadeOut(1000, fadeInBody);
      $(".quote-text, .quote-author").fadeOut(1000, fadeInQuote);
    });
    //Like this app and share it on Facebook.
    $(".like").click(function() {
      window.open("https://www.facebook.com/sharer/sharer.php?u=https://codepen.io/Milthir/pen/eypMPE?editors=1111");
    });
    //Tweet current quote with #inspiration.
  ...
  //Footer buttons
  //Opens Codepen profile in new widnow
  $(".codepen").click(function() {
    window.open("https://codepen.io/Milthir/#");
  });
  //Opens Github profile in new window.
